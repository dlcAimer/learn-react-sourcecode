...
function completeWork(
  ...
  switch (workInProgress.tag) {
    ...
    case HostComponent: {
      ...
      // 进行水合的时候只有 workInProgress 树，current 树只有 rootFiberNode
      if (current !== null && workInProgress.stateNode != null) {
        ...
        if (!newProps) {
          ...
          // 收集子节点的 lanes/subtreeFlags/duration 等
          bubbleProperties(workInProgress);
          return null;
        }
        ...
        if (wasHydrated) {
          ...
          if (
            ...
            // 如果 dom.attributes 和 props 存在差异且需要更新
            markUpdate(workInProgress);
          }
        } else {
          // 当前 fiber 节点没有水合，根据当前环境创建 dom 节点实例
