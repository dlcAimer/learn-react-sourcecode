...
export function reconcileChildren(
  ...
  if (current === null) {
    ...
    /**
     * mount 阶段，这是一个还未渲染的全新组件，我们不用通过对比最小副作用来更新它的子节点。
     * 直接转换 nextChildren 即可，不用标记哪些节点需要删除等等
     */
    ...
    workInProgress.child = reconcileChildFibers(
      workInProgress,
      /**
       * 因为我们要构建的是 workInProgress 的子节点，这里也传入 current 的子节点，
       * 方便后续的对比和复用
       */
      current.child,
      nextChildren,
